...
import { idlFactory } from './cafeteria.did.js';
export { idlFactory } from './cafeteria.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CAFETERIA;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cafeteria.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cafeteria canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cafeteria.did.js")._SERVICE>}
 */
export const cafeteria = createActor(canisterId);
